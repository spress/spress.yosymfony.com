---
layout: page-dev
title: Developers &#8250; Creating a plugin on Spress 1.x
description: Getting started with Spress 1.x plugins
header:
  title: Creating a plugin on Spress 1.x
  sub: Developers
menu:
  id: dev 1.0
    ...
    <tbody>
        <tr>
            ...
            <td markdown="1">
                ...
                See [Events list](/docs/1.0/developers/events-list).
            </td>
        </tr>
        <tr>
            <td>$listener</td>
